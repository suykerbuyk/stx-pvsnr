...
configure_repositories:
  file.recurse:
    ...
    - source: salt://build_ostackblade/files/etc/yum.repos.d
    - clean: True
    - keep_source: False
    - dir_mode: 0755
    - file_mode: 0644
...
update_packages:
  cmd.run:
    - name: /bin/yum install -y --installroot={{mnt_point1}}/ tmux screen salt-minion centos-release-openstack-rocky openstack-packstack
    - require:
      - import_rpm_keys
...
update_yum:
  cmd.run:
    - name: /bin/yum update -y --installroot={{mnt_point1}}/ 
    - require:
      - import_rpm_keys
...
set_salt_dir_files:
  file.recurse:
    ...
    - source: salt://build_ostackblade/files/etc/salt
    - clean: True
    - keep_source: False
    - dir_mode: 0755
    - file_mode: keep
