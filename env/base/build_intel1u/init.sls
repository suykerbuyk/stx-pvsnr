...
{% set stx_boot_disks = salt['stx_disk.by_criteria']('20', '4096') %}
...
set_salt_dir_files:
  file.recurse:
    ...
    - source: salt://build_intel1u/files/etc/salt
    - clean: True
    - keep_source: False
    - dir_mode: 0755
    - file_mode: keep
...
set_bin_files:
  file.recurse:
    - name: {{mnt_point1}}/bin
    - source: salt://build_intel1u/files/bin
    - keep_source: False
    - dir_mode: 0755
    - file_mode: 0755
    - keep_symlinks: False
...
set_root_ssh_dir_files:
  file.recurse:
    ...
    - source: salt://build_intel1u/files/root/ssh
    - keep_source: False
    - dir_mode: 0700
    - file_mode: 0600
    - user: root
...
set_etc_ssh_dir_files:
  file.recurse:
    ...
    - source: salt://build_intel1u/files/etc/ssh
    - keep_source: False
    - dir_mode: 0755
    - file_mode: keep
    - user: root
